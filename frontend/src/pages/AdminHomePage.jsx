  ...
  return (
    ...
    <div className="max-w-7xl mx-auto p-6">
        ...
        {productsLoading || orderLoading ? (
            ...
            <p className='text-red-500 '>Error fetched products :{productError}</p>
        ):orderError?(
            <p className='text-red-500 '>Error fetched orders :{orderError}</p>
        ):(
            ...
            <div className="overflow-x-auto">
                <table className="min-x-full text-left text-gray-500">
                    ...
                    <tbody>
                        {orders.length > 0 ? (
                            orders.map((order)=>(
                                <tr key={order._id} className=' shadow-sm hover:bg-gray-50 cursor-pointer'>
