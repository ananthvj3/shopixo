...
useEffect(()=>{
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      <h2 className="text-xl sm:text-sxl font-bold mb-6">My Orders</h2>
          ...
          <tbody>
            {order.length > 0 ?(
              order.map((order)=>(
                ...
                className='shadow-sm hover:border-gray-50 cursor-pointer'>
                  <td className="py-2 px-2 sm:pyu-4 sm:px-4">
                  ...
                  whitespace-nowrap ">#{order._id}</td>
                  ...
                  <td className="py-2 px-2 sm:px-4 sm:py-4">
                   ...
                   <td className="py-2 px-2 sm:px-4 sm:py-4">
                    ...
                    <td className="py-2 px-2 sm:px-4 sm:py-4">
                      <span className={`${order.isPaid ? "bg-green-100 text-green-700" : "bg-red-7100 text-red-700"}
