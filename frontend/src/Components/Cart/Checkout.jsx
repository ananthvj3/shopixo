...
const Checkout = () => {
    ...
    const handleCreateCheckout=async (e)=>{
      ...
      // Aevgy4i6LF2rQV74LNkay0XoUC0jjuHNK6IFwqKzdtmadI8UT8fjhCWy_oU8LDKDaXQmiMLHXarLAyIt
    }
        ...
        <div className="bg-gray-50 p-6 rounded-lg ">
            ...
            <div className="border-t py-4 mb-4">
                {cart.products.map((product,index)=>(
                    <div keu={index} className='flex items-center justify-between py-2 shadow-lg'>
            ...
            <div className="flex justofy-between items-center text-lg mb-4 ">
                <p>Subtotal</p>
