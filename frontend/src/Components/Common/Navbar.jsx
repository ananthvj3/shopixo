...
const Navbar = () => {
  ...
  return (
    <>
      <nav className='mx-auto flex items-center justify-between py-4 px-6  shadow-lg'>
        
        <div>
          <Link to="/" className="text-2xl font-medium">Shopixo</Link>
        </div>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <button onClick={toggleCartDrawer} className='relative hover:text-black'>
            <HiOutlineShoppingBag className='h-6 text-gray-700' />
            {cartItemCount > 0 && (
      ...
      transition-transform duration-300 z-50 ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className='p-4'>
          <h2 className='tyext-xl font-semibold mb-4'>Menu</h2>
