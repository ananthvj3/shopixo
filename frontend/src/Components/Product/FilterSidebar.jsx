...
const FilterSidebar = () => {
  ...
  const materials = ["Cotton", "Wool", "Demin", "Polyester", "Silk", "Linen", "Viscose", "Fleece"];
  const brands = ["Urban Threads", "Modern Fit", "Street Style", "each Breeze", "Fashionista", "ChicStyle"];
  ...
  return (
    <>
      <div className="p-4">
        ...
        <div className="mb-8 ">
          <label  className=" block text0gray-600 font-medium mb-2">
            Price Range
          </label>
